...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Mazensaid24/telmazn"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "D2_RK")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph//file/c51c1ee7290c213b11bb6.jpg"
    )
    ...
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/source-dark/ZVCPlayer")

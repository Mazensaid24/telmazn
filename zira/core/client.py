...
ZDEV = (5951674553, 6816180621, 6748769780)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @Ve_G4\
                                  \n\n--------بـدء تتبـع سجـل كاتيا 𝗞𝗮𝗧𝘆𝗔--------\
                        ...
                        link = "[𓂄𓆩νιρ ʍαzεπ𓆪‌‌‏𓂁](https://t.me/Ve_G4)"
                        text = (
                            "**✘ تقـريـر اشعـار كاتيا 𝗞𝗮𝗧𝘆𝗔 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار دارك 𝗞𝗮𝗧𝘆𝗔 ✘**\n\n "
                        link = "[𓂄𓆩νιρ ʍαzεπ𓆪‌‌‏𓂁](https://t.me/Ve_G4)"

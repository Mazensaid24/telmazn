...
Zed_Vip = (5951674553, 6321842698, 6496589900)
zchannel = {"@Source_Katya"}
...
async def autovars(): #Code by T.me/Ve_G4
...
async def autoname(): #Code by T.me/Ve_G4
...
async def mybot(): #Code by T.me/Ve_G4
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "DARK")
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/f56c2e9a62ad563b844b3.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس كاتيا الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗞𝗮𝗧𝘆𝗔𓅛", "https://t.me/Source_Katya"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل كاتيا", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )

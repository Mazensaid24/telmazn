#Source_Katya ®
#الملـف حقـوق وكتابـة 𓂄𓆩νιρ ʍαzεπ𓆪‌‌‏𓂁 ⤶ @Ve_G4 خاص بسـورس ⤶ Source_Katya
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗞𝗮𝗧𝘆𝗔 𓆪 </b> - @Source_Katya "
...
async def who(event):
    ...
    zel_dev = (5951674553, 6748769780, 6816180621)
    ...
    if replied_user.id == 5951674553 or replied_user.id == 6748769780 or replied_user.id == 6816180621:

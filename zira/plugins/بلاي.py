...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗮𝗧𝘆𝗔   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝗞─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𓂄𓆩νιρ ʍαzεπ𓆪‌‌‏𓂁](t.me/Ve_G4)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [𝗞𝗮𝗧𝘆𝗔](https://t.me/Source_Katya)  "
)
...
@zedub.zed_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس دارك",
        "الاستـخـدام": "{tr}بلاي",
    },
)

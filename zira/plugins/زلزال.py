# Source_Katya
# Copyright (C) 2023 Source_Katya . All Rights Reserved
#
# This file is a part of < https://github.com/Zed-Thon/ZelZal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Source_Katya/Ve_G4/blob/master/LICENSE/>.
import requests
import asyncio
import os
import sys
...
#الملـف كتابـة مازن ⤶ @Ve_G4 خاص بسـورس ⤶ 𝗞𝗮𝗧𝘆𝗔
...
async def _(event):
    ...
    async with borg.conversation(chat) as conv: # code by t.me/Ve_G4
        try:
...
async def linkapk(event):
    ...
    if input_str == "الحذف":
        return
    chat = "@apkdl_bot" # code by t.me/Ve_G4

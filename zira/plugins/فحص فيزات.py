...
""" 
CC Checker & Generator for 𝗞𝗮𝗧𝘆𝗔™ t.me/Source_Katya
Write file by Zelzal t.me/Ve_G4
hhh o ya beby
...
async def song2(event):
    ...
    chat = "@SDBB_Bot" # code by t.me/Ve_G4
...
async def song2(event): # code by t.me/A7_M3
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by t.me/Ve_G4
    chat = "@SDBB_Bot" # code by t.me/A7_M3
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by t.me/Ve_G4
    chat = "@SDBB_Bot" # code by t.me/A7_M3
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by t.me/Ve_G4
    chat = "@SDBB_Bot" # code by t.me/Ve_G4
    reply_id_ = await reply_id(event)

...
ZelzalPH_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗮𝗧𝘆𝗔 📲 - كـاشـف الارقـام العربيــة](t.me/Source_Katya) 𓆪\n\n"
    "**⪼ الامــر ↵**\n\n"
...
async def _(event): #Code by T.me/Ve_G4
    ...
    zelzal = "@ZZIIIbot" #Code by T.me/Ve_G4
    zed = await edit_or_reply(event, "**⎉╎جـارِ الكشـف عن الرقـم 📲**\n**⎉╎انتظـر قليـلاً ... ▬▭**")
    async with borg.conversation(zelzal) as conv: # code by t.me/Ve_G4
        try:

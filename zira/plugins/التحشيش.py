...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗮𝗧𝘆𝗔 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/Source_Katya) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗞𝗮𝗧𝘆𝗔─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف¹  ↬** @LC6BOT\n**✵│بـوت الحـذف²  ↬** @DTeLebot")
##
...
#
ZelzalTHS_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗮𝗧𝘆𝗔 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/Source_Katya) 𓆪\n\n"
...
async def permalink(malath):
    ...
    if user.id in zel_dev:
        return await edit_or_reply(malath, f"**╮ ❐ لك هـذا كاتيا الهكر . . شما حجيت ماكـدر اوصفـه 🙊💘 ❏╰**")
    tag = user.first_name.replace("\u2060", "") if user.first_name else user.username
